    ...
    try:
        ...
        for data_row in soup.find_all("div", class_="general-info-wrapper"):
            ...
            if data_row.find("h4", string="State of the property"):
                property_data["building_condition"] = (
                    data_row.find("h4", string="State of the property")
                    .find_next_sibling()
                    .get_text()
                )
            ...
            if data_row.find("h4", string="Total land surface"):
                property_data["land_area_m2"] = (
                    data_row.find("h4", string="Total land surface")
                    .find_next_sibling()
                    .get_text()
                )
            ...
            if data_row.find("h4", string="Number of facades"):
                property_data["number_of_facades"] = (
            ...
            if data_row.find("h4", string="Number of bedrooms"):
                property_data["number_of_bedrooms"] = (
                    data_row.find("h4", string="Number of bedrooms")
                    .find_next_sibling()
                    .get_text()
                )
