...
## Importing files
from scraping.improved_scrape_a_property import improved_scrape_data_from_property_page
...
# It's mostly edo's work, i've modified to include a print and error handling, though that was added to the scraping function itself.
...
def simpler_scrape_all_property_pages_with_index(source_file, target_path, clean_data_path):
    ...
    with requests.Session() as session:
        with ThreadPoolExecutor(max_workers=10) as executor:
            ...
            # printing progress, handling errors and writing to file (ordered, no nulls)
